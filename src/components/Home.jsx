...
const   Home = () => {
  return (
    <div className="flex mb-20">
      ...
      <img src='https://media.licdn.com/dms/image/D4D12AQHbWmvLqxpiuw/article-cover_image-shrink_720_1280/0/1691511597324?e=1720051200&v=beta&t=6SgF0pJeIXzNvWIKKnV2dYjUthKWWj4OgxdA2mLqgeg' className='object-contain md:object-scale-down flex h-auto max-w-lg mt-20' ></img></div>
    </div>
  )
  }
