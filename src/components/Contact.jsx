      ...
      <form action="https://formspree.io/f/mleqpger" method="POST" className="w-full max-w-lg text-center p-9 items-center" >
        <div  class="flex flex-wrap -mx-3 mb-6 items-center">
          ...
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input type="text" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Doe" aria-label="name" required name="Name" />
          </div>
          <div className="w-full md:w-1/2 px-3 md:mb-0">
          <label for="exampleInputEmail1" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" placeholder="Your email...">Email :</label>
